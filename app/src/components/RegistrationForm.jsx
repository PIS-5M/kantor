...
import { Input, InputGroup, Button, Form, FormFeedback } from "reactstrap";
...
function RegistrationForm() {
  ...
  const isValid = () => {
    if (keysToCheck.every((key) => formData.validate[key] === "has-success"))
      return true;
    return false;
  };
      ...
      <div className="registrationForm">
        ...
        <Form>
          ...
          <InputGroup className="inputGroup">
            ...
            />
            <FormFeedback>
              Hasło musi zawierać co najmniej 8 znaków, małą i wielką literę,
