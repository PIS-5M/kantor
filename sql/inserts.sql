INSERT INTO `currency` (`currency_id`, `name`, `abbreviation`, `account_number`) VALUES
(1, 'Dolar Amerykański', 'USD', '12345678901234567890123456'),
(2, 'Euro', 'EUR', '98765432109876543210987654'),
(3, 'Funt Brytyjski', 'GBP', '55552222333344446666777788'),
(4, 'Jen Japoński', 'JPY', '99998888777766665555444433'),
(5, 'Dolar Kanadyjski', 'CAD', '77776666555544443333222211'),
(6, 'Dolar Australijski', 'AUD', '12341234123412341234123412'),
(7, 'Frank Szwajcarski', 'CHF', '99996666333311112222444499'),
(8, 'Juan Chiński', 'CNY', '88887777666655554444333322'),
